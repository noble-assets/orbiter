...
const (
	Msg_SubmitPayload_FullMethodName = "/noble.orbiter.v1.Msg/SubmitPayload"
)
...
func (c *msgClient) SubmitPayload(ctx context.Context, in *MsgSubmitPayload, opts ...grpc.CallOption) (*MsgSubmitPayloadResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SubmitPayload_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) SubmitPayload(context.Context, *MsgSubmitPayload) (*MsgSubmitPayloadResponse, error) {
...
func _Msg_SubmitPayload_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_SubmitPayload_FullMethodName,
	}
