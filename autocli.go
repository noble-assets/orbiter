...
func (AppModule) AutoCLIOptions() *autocliv1.ModuleOptions {
	return &autocliv1.ModuleOptions{
		Tx: &autocliv1.ServiceCommandDescriptor{
			...
			SubCommands: map[string]*autocliv1.ServiceCommandDescriptor{
				"executor": {
					...
					SubCommands:          map[string]*autocliv1.ServiceCommandDescriptor{},
					RpcCommandOptions:    getExecutorRPCTxOptions(),
				...
				"forwarder": {
					...
					SubCommands:          map[string]*autocliv1.ServiceCommandDescriptor{},
					RpcCommandOptions:    getForwarderRPCTxOptions(),
					EnhanceCustomCommand: true,
				},
				"adapter": {
					Service:              adapter.Msg_serviceDesc.ServiceName,
					Short:                "Cross-chain adapter management commands",
					SubCommands:          map[string]*autocliv1.ServiceCommandDescriptor{},
					RpcCommandOptions:    getAdapterRPCTxOptions(),
					EnhanceCustomCommand: true,
				},
			},
		},
		Query: &autocliv1.ServiceCommandDescriptor{
			...
			SubCommands: map[string]*autocliv1.ServiceCommandDescriptor{
				"adapter": {
					Service:           adapter.Query_serviceDesc.ServiceName,
					Short:             "Cross-chain adapter query commands",
					SubCommands:       map[string]*autocliv1.ServiceCommandDescriptor{},
					RpcCommandOptions: getAdapterRPCQueryOptions(),
				},
			},
		},
	}
...
func getExecutorRPCTxOptions() []*autocliv1.RpcCommandOptions {
...
func getForwarderRPCTxOptions() []*autocliv1.RpcCommandOptions {
	return []*autocliv1.RpcCommandOptions{
		{
...
func getAdapterRPCTxOptions() []*autocliv1.RpcCommandOptions {
	return []*autocliv1.RpcCommandOptions{
		{
			RpcMethod: "UpdateParams",
			Use:       "update-params [new_params]",
			Short:     "",
			Long:      "",
			PositionalArgs: []*autocliv1.PositionalArgDescriptor{
				{ProtoField: "params"},
...
func getAdapterRPCQueryOptions() []*autocliv1.RpcCommandOptions {
	return []*autocliv1.RpcCommandOptions{
		{
			RpcMethod: "Params",
			Use:       "params",
