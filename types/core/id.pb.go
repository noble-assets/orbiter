...
func (m *OrbitID) Reset()      { *m = OrbitID{} }
func (*OrbitID) ProtoMessage() {}
func (*OrbitID) Descriptor() ([]byte, []int) {
	return fileDescriptor_02f991dccbb42578, []int{0}
}
func (m *OrbitID) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *OrbitID) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_OrbitID.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *OrbitID) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OrbitID.Merge(m, src)
}
func (m *OrbitID) XXX_Size() int {
	return m.Size()
}
func (m *OrbitID) XXX_DiscardUnknown() {
	xxx_messageInfo_OrbitID.DiscardUnknown(m)
}

var xxx_messageInfo_OrbitID proto.InternalMessageInfo

func (m *OrbitID) GetProtocolId() ProtocolID {
	if m != nil {
		return m.ProtocolId
	}
...
func (m *OrbitID) GetCounterpartyId() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*OrbitID)(nil), "noble.orbiter.core.v1.OrbitID")
}
...
var fileDescriptor_02f991dccbb42578 = []byte{
	...
	,
}

func (m *OrbitID) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *OrbitID) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *OrbitID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *OrbitID) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: OrbitID: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: OrbitID: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
