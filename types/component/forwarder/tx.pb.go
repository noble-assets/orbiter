...
import (
	...
	math "math"
	math_bits "math/bits"
	identifier "orbiter.dev/types/identifier"
)
...
type MsgPauseProtocol struct {
	...
	ProtocolId identifier.ProtocolID `protobuf:"varint,2,opt,name=protocol_id,json=protocolId,proto3,enum=noble.orbiter.identifier.v1.ProtocolID" json:"protocol_id,omitempty"`
}
...
var fileDescriptor_6d12dabcf7836b4c = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProtocolId |= identifier.ProtocolID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
