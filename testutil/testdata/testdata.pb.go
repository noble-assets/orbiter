...
type TestOrbitAttr struct {
	Planet string `protobuf:"bytes,1,opt,name=planet,proto3" json:"planet,omitempty"`
}

func (m *TestOrbitAttr) Reset()         { *m = TestOrbitAttr{} }
func (m *TestOrbitAttr) String() string { return proto.CompactTextString(m) }
func (*TestOrbitAttr) ProtoMessage()    {}
func (*TestOrbitAttr) Descriptor() ([]byte, []int) {
	return fileDescriptor_bc244d00904a39a7, []int{0}
}
func (m *TestOrbitAttr) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOrbitAttr) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOrbitAttr.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *TestOrbitAttr) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOrbitAttr.Merge(m, src)
}
func (m *TestOrbitAttr) XXX_Size() int {
	return m.Size()
}
func (m *TestOrbitAttr) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOrbitAttr.DiscardUnknown(m)
}

var xxx_messageInfo_TestOrbitAttr proto.InternalMessageInfo

func (m *TestOrbitAttr) GetPlanet() string {
	if m != nil {
		return m.Planet
	}
	return ""
...
func init() {
	proto.RegisterType((*TestOrbitAttr)(nil), "testpb.TestOrbitAttr")
...
var fileDescriptor_bc244d00904a39a7 = []byte{
	...
	,
}

func (m *TestOrbitAttr) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *TestOrbitAttr) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOrbitAttr) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOrbitAttr) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOrbitAttr) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: TestOrbitAttr: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestOrbitAttr: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
