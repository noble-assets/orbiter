...
var _ executor.QueryServer = &queryServerExecutor{}

type queryServerExecutor struct {
	*Keeper
}

func NewQueryServerExecutor(keeper *Keeper) queryServerExecutor {
	return queryServerExecutor{Keeper: keeper}
}
